...
var paulo_R = index.match(Sayo_Regk);
var paulo_RR = index.match(Sayo_Regkk);
var paulo_RRR = paulo_RR[0].split('title=').join('').split('>').join('');
//var paulo_RRRR = index.match(Sayo_Regkkk);
var opções = {
título: JSON.parse(paulo_RRR),
//duração: JSON.parse(paulo_RRRR),
...
module.exports = { styletext, gpwhatsapp, hentaistube, nerding, apkmodhacker, xvideos, uptodown, pornhub, soundl, st, gpsrc, dafontSearch, dafontDown, igstalk, ff, papeldeparede, htdl, xvideoss, xvideosdl, assistithtdl, assistitht, pornogratis, wallmob }
