...
const { dafontSearch, dafontDown } = require("../lib/api");
...
async function dafontSearchr(req, res) {
    ...
    dafontSearch(query).then(result => {
        limitAdd(apikey);
...
async function dafontDownr(req, res) {
...
module.exports = { dafontSearchr, dafontDownr };