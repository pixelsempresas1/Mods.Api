...
const { assistithtdl, assistitht, } = require("../lib/api");

async function assistithtr(req, res) {
...
async function assistithtdlr(req, res) {
...
module.exports = { assistithtr, assistithtdlr };