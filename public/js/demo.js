...
//      alert('Acabei deletando os login de todo mundo sem querer :(')
    }
  }, 1000)
  ...
  $container.append('<h6>Copyright Opção</h6>')
  ...
  $container.append('<h6>Deixar com texto pequeno</h6>')
  ...
  var $text_sm_body_container = $('<div />', { class: 'mb-1' }).append($text_sm_body_checkbox).append('<span>Ínicio</span>')
  ...
  var $text_sm_sidebar_container = $('<div />', { class: 'mb-1' }).append($text_sm_sidebar_checkbox).append('<span>Barra Lateral de Nav</span>')
  ...
  var $text_sm_footer_container = $('<div />', { class: 'mb-4' }).append($text_sm_footer_checkbox).append('<span>Copyrights</span>')
